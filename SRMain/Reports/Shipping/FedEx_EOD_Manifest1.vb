...
Namespace ShipRiteReports
    ...
    Public Class FedEx_EOD_Manifest
        ...
        Public Overrides Property FullResourceName() As String
            Get
                Return "SHIPRITE.FedEx_EOD_Manifest.rpt"
            End Get
            Set
                'Do nothing
            End Set
    ...
    Public Class CachedFedEx_EOD_Manifest
        Inherits Component
        ...
        Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
            Dim rpt As FedEx_EOD_Manifest = New FedEx_EOD_Manifest()
            rpt.Site = Me.Site
            Return rpt
        End Function
